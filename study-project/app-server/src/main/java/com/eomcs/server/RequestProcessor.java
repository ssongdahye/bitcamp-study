...
public class RequestProcessor extends Thread {
  ...
  public void run() {
    try (Socket socket = this.socket;
      ...
      sendResult(response, out, in); // 클라이언트에게 실행 결과를 보낸다.
  ...
  private void sendResult(Response response, PrintWriter out, BufferedReader in) throws Exception {

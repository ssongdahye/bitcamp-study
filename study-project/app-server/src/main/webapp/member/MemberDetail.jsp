...
<button class="btn btn-primary btn-small">변경</button>
<a href='delete?no=${member.no}' class="btn btn-primary btn-small">삭제</a>
<a href='list' class="btn btn-primary btn-small">목록</a><br>
</form>
</div> <!-- .container -->

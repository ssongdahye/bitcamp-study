...
public class Exam0110 {
  ...
  void test() {
    ...
    // b.m1(); // 컴파일 오류 --> ProtocaolImpl.m1()
    ((ProtocolImpl)b).m1(); // ProtocaolImpl.m1()
    ...
    ProtocolA a = obj;
    a.rule1(); // OK --> ProtocolB.rule2()
    // a.rule2(); // 컴파일 오류 --> ProtocolA.rule1()
    ((ProtocolImpl)a).rule2(); // OK --> ProtocolA.rule1()
    // a.m1(); // 컴파일 오류 --> ProtocaolImpl.m1()
    ((ProtocolImpl)a).m1(); // ProtocaolImpl.m1()
